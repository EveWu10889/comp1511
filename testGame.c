...
// Make new game
// Give arrays of colors, values, suits
// Call functions in game.c like getNumCards... etc and check output
// eg newGame
static void test1_init_deck_hands(Game game);
static void test1_play_basic_hands(Game game);
...
int main (void){
    ...
    value values[] = {
        ...
        THREE, NINE, D, B,
        SIX, SIX, FOUR, FIVE,
        FIVE, THREE, SIX, SEVEN,
        THREE, SEVEN, FIVE, SIX
    };
    ...
    test1_init_deck_hands(game);
    test1_play_basic_hands(game);
...
static void test1_init_deck_hands(Game game){
    ...
    printf("Checking if number of two cards at the top of deck is 0\n\n");
    ...
    printf("Checking if the current number of active DRAW_TWO is 0\n\n");
    assert(getActiveDrawTwos(game) == 0);

    printf("Checking if the current number of cards in current player's hand is 7\n\n");
    assert(playerCardCount(game, 0) == 7);

    printf("Checking if the game is not finished\n\n");
...
static void checkPlayer2Turn2(Game game){
    ...
    printf("Checking the game state\n");
    checkGameState(game, 2, 7, 0, 1, 6);

    printf("Checking player 2 has ");
    printCardByComponents(E, BLUE, DIAMONDS);
    printf("\n");
    card = findCardInHand(game, 2, E, BLUE, DIAMONDS);
    assert(card != NULL);
...
static void checkPlayer3Turn2(Game game){
    ...
    printf("Checking the game state\n");
    checkGameState(game, 3, 8, 0, 2, 7);

    printf("Checking player 3 has ");
    printCardByComponents(2, BLUE, HEARTS);
    printf("\n");
    card = findCardInHand(game, 3, 2, BLUE, HEARTS);
    assert(card != NULL);
    ...
    printCardByComponents(2, BLUE, HEARTS);
    printf("\n");
    card = findCardInHand(game, 2, 2, BLUE, HEARTS);
    assert(card == NULL);

    printf("Checking the game state\n");
    checkGameState(game, 0, 9, 1, 2, 8);
