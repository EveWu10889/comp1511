...
complex complexAdd(complex a, complex b) {
    // PUT YOUR CODE HERE;
    complex result;
    // result = (a.real + b.real) + (a.imaginary + b.imaginary)i
...
complex complexMultiply(complex a, complex b) {
    // PUT YOUR CODE HERE;
    complex result;
    // result = (a.real * b.real - a.imaginary * b.imaginary) + (a.imaginary * b.real + a.real * b.imaginary)i
...
complex complexSquare(complex c) {
    // PUT YOUR CODE HERE;
    complex result;
    //result = (c.real * c.real) + (c.imaginary * c.imaginary) * i * i + (2 * c.real * c.imaginary) * i
